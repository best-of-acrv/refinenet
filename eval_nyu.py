...
if __name__ == '__main__':
    ...
    if args.num_resnet_layers == 50:
        model = refinenet50(num_classes=dataset.num_classes, pretrained='nyu')
    elif args.num_resnet_layers == 101:
        model = refinenet101(num_classes=dataset.num_classes, pretrained='nyu')
    elif args.num_resnet_layers == 152:
        model = refinenet152(num_classes=dataset.num_classes, pretrained='nyu')
    else:
