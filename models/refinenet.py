...
class RefineNet(nn.Module):
    ...
    def _make_crp(self, in_planes, out_planes, stages):
        layers = [ChainedResidualPool(in_planes, out_planes, stages)]
        return nn.Sequential(*layers)

    def _make_rcu(self, in_planes, out_planes, blocks, stages):
        layers = [ResidualConvUnit(in_planes, out_planes, blocks, stages)]
        return nn.Sequential(*layers)
...
pretrained_urls = {
    ...
    'refinenet101_voc': 'https://cloudstor.aarnet.edu.au/plus/s/PhXsS5k7iXJqIQV/download',
